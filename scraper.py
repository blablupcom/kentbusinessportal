    ...
    for portal in portals:
        ...
        for link in links:
            ...
            #     print "got tender " + linkcont + " already."
                ...
                scraperwiki.sqlite.save(unique_keys=['l'], data={"l": unicode(link).decode('utf-8'), "tender_id": unicode(tender_id).decode('utf-8'), "buyer": unicode(buyer).decode('utf-8'), "title" : unicode(title).decode('utf-8'), "categories": unicode(categories).decode('utf-8'),  "d": todays_date})
